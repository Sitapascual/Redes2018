...
public abstract class NGMessage {
	...
	public static final byte OP_SEND_TOKEN = 0;
	public static final byte OP_TOKEN_VALID = 0;
	...
	public static NGTokenMessage makeTokenMessage(byte opSendToken, long token) {
